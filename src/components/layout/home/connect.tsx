                                ...
                                <div className="flex h-full flex-col justify-center gap-10 p-4 md:h-[300px] md:flex-row">
                                    ...
                                    >
                                        ...
                                        <div id="pointer" className="absolute">
                                            ...
                                            <span className="bg-ali relative -top-1 left-3 rounded-3xl px-2 py-1 text-xs">
                                                Kasumi
                                            </span>
                                        </div>
                                    </div>
                                        ...
                                        <div className="flex flex-col items-center">
                                            <h3 className="mt-6   pb-1 font-bold ">
                                                <span className="text-2xl md:text-4xl">
                                                    Bạn muốn học tập ngoại ngữ cùng Kasumi?
                                                </span>
                                            </h3>
                                        </div>
                                        <p className="mb-4 text-slate-400">
                                            Chúng tôi cung cấp các khóa học ngoại ngữ chất lượng cao với
                                            đội ngũ giáo viên giàu kinh nghiệm và phương pháp giảng dạy hiện đại.
                                        </p>
