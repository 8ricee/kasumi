...
export function SparklesPreview() {
  return (
    <div className="h-[20rem] w-full flex flex-col items-center justify-center overflow-hidden rounded-md">
      <Link href="/" className="md:text-7xl text-3xl lg:text-9xl font-bold text-center relative z-20 cursor-pointer bg-clip-text text-transparent bg-gradient-to-r from-indigo-500 via-slate-200 to-rose-500 dark:from-indigo-300 dark:via-white/90 dark:to-rose-300">
        Kasumi
